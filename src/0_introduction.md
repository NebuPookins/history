...
The transition from ancient history to post-classical history happens around 500 CE, where major religions begin to take a much more prominent role.

The transition from post-classical history to modern history starts around 1500 CE, around when the scientific revolution occurred, leading to humanism, the enlightenment and secularization.

```mermaid
timeline
  title History
  200,000 BCE (Prehistory, lasting roughly 200,000 years)
    : Anatomically modern humans appear
    : Migrate out of Africa
    : Agriculture
    : Writing
  3500 BCE (Ancient History, lasting roughly 4000 years)
    : Civilizations (Mesopotamia, Egypt, China, Peru, India, Persia)
    : Trade Networks
    : Hinduism, Buddhism, Confucianism, Judaism, Greek philosophy
  500 CE (Post-classical history, lasting roughly 1000 years)
    : World religions (Buddhism, Christianity, Islam) spread via missionaries
  1500 CE (Modern history, lasting roughly 500 years)
    : Western culture rise to power
    : Americas trading with Europe
    : Biological exchange of plants, animals, people, diseases
...
back: Ancient history. Creation is roughly dated to 4000 BCE, the great flood around 2300 BCE, the exodus from Egypt around 1400 BCE.
```
